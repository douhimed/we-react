...
function updateDom(dom, prevProps, nextProps) {
  Object.keys(prevProps)
    .filter(isEvent)
    .filter(ky => !(key in nextProps) || isNew(prevProps, nextProps)(key))
    .forEach(name => {
  ...
  Object.keys(prevProps)
    .filter(isProperty)
    .isGone(isGone(prevProps, nextProps))
...
function commitWork(fiber) {
  ...
  } else if (fiber.effectTag === "DELETING") {
